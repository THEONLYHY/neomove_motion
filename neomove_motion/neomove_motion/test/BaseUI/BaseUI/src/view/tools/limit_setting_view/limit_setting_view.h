...
#ifndef PROBE_STATION8_SRC_VIEW_TOOLS_LIMIT_SETTING_VIEW_LIMIT_SETTING_VIEW_H_
#define PROBE_STATION8_SRC_VIEW_TOOLS_LIMIT_SETTING_VIEW_LIMIT_SETTING_VIEW_H_
...
QT_BEGIN_NAMESPACE
namespace Ui {
class limit_condition_viewClass;
};
QT_END_NAMESPACE
...
class LimitSettingView : public QDialog {
 ...
 private:
  PsComboBox *GetAxisLimitTypeComboBox();
  PsComboBox *GetIoLimitTypeComboBox();
  PsComboBox *GetAxisNameComboBox();
  PsComboBox *GetAxisRegionNameComboBox(std::string axis_name);
  PsComboBox *GetIONameComboBox();
  PsComboBox *GetAxisStatesComboBox();
  PsComboBox *GetAxisRegionStatesComboBox();
  PsComboBox *GetIOStatesComboBox();
 ...
 private:
  Ui::limit_condition_viewClass *ui;
};

#endif  // PROBE_STATION8_SRC_VIEW_TOOLS_LIMIT_SETTING_VIEW_LIMIT_SETTING_VIEW_H_
